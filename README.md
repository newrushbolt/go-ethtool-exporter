...
Have a look at [USECASES.md](USECASES.md)
...
|                                                      Exporter                                                           | Structured and vendor abstract | [Generic info](## "ethtool eth0") | [Module info](## "ethtool -m eth0") | [Driver info](## "ethtool -i eth0") |  [Statistics](## "ethtool -S eth0")   |
|-------------------------------------------------------------------------------------------------------------------------|--------------------------------|-----------------------------------|-------------------------------------|-------------------------------------|---------------------------------------|
